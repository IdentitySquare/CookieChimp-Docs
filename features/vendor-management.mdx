...
description: "Organize categories, vendors, and storage items in CookieChimp."
---
...
You can then use the services attribute to [block scripts until consent](/block-scripts-cookies).
