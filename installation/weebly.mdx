...
<AccordionGroup>
  ...
  <Accordion title="Does CookieChimp support Google Consent Mode v2 on Weebly?">
  ...
  <Accordion title="Can I customize the banner to match my Weebly site's design?">
    Yes. Use the [Banner Designer](/features/banner-designer) to match colors, fonts and styles to your Weebly theme.
  </Accordion>
</AccordionGroup>
