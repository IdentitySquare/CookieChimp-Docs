...
<CardGroup cols={2}>
  <Card title="HTML" icon="code" href="/installation/html">Add the snippet to a static HTML site — also a useful reference for understanding how CookieChimp works under the hood.</Card>
</CardGroup>
