...
<AccordionGroup>
  ...
  <Accordion title="Will CookieChimp slow down my one-page Carrd site?">
    No. CookieChimp is a small, asynchronously-loaded script (~30KB gzipped) served from a global CDN. Carrd's PageSpeed scores stay essentially unchanged.
  </Accordion>
  ...
  <Accordion title="Can I match the banner to my Carrd site's design?">
    Yes. Customize colors, fonts, corner radius and copy in the [Banner Designer](/features/banner-designer) so it matches your Carrd palette.
  </Accordion>
</AccordionGroup>
