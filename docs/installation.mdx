...
Add your website's CookieChimp JS snippet at the top of the `<head>` tag of your HTML:

<Info>
  Add the CookieChimp script at the top of the `<head>` section to make sure it loads first.
</Info>
