---
title: "Next.js"
description: "Add CookieChimp to your Next.js application with minimal integration"
icon: "react"
---

# Next.js + CookieChimp (Minimal Integration)

This page shows the **simplest** way to add CookieChimp to a Next.js app and log whether a **specific service** (e.g., "Google Analytics" in the "analytics" category) is allowed.
...
## Step 2 — Add a minimal consent logger

This tiny client component:
...
export default function ConsentLogger() {
  useEffect(() => {
    function logConsent() {
      ...
      console.log(allowed ? "✅ Google Analytics allowed" : "❌ Google Analytics blocked");
    }
...
For more advanced integration patterns, including category-level consent checking and custom consent buttons, see our [JavaScript & SPA guide](/docs/installation/single-page-applications).
